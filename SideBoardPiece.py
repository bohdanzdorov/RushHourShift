...
class SideBoardPieces(BoardPiece):
    ...
    def shift(self, numberToShift, directionToShift, Vehicles):
        if self.isShiftable(numberToShift, directionToShift, Vehicles):
